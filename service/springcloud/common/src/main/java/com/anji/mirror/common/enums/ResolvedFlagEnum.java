...
public enum ResolvedFlagEnum {
    ...
    private ResolvedFlagEnum(int  codeValue, String codeDesc) {
    ...
    //根据codeValue获取枚举
    public static ResolvedFlagEnum parseFromCodeValue(int codeValue){
        for (ResolvedFlagEnum e : ResolvedFlagEnum.values()){
    ...
    public static String getCodeDescByCodeBalue(int codeValue){
        ResolvedFlagEnum enumItem = parseFromCodeValue(codeValue);

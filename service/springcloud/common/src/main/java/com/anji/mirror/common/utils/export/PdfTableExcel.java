...
//                pdfpCell.setVerticalAlignment(cell.getCellStyle().getVerticalAlignmentEnum().ordinal());
                pdfpCell.setVerticalAlignment(Element.ALIGN_CENTER);
//                pdfpCell.setHorizontalAlignment(cell.getCellStyle().getAlignmentEnum().ordinal());

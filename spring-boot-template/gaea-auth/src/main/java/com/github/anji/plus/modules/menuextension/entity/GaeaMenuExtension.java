package com.github.anji.plus.modules.menuextension.entity;
 ...
 */
@TableName("gaea_menu_extension")
public class GaeaMenuExtension extends GaeaBaseEntity implements Serializable {
    /**
     * 表格code
     */

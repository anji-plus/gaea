package com.anjiplus.template.common.aop;
...
import com.anjiplus.template.common.util.DynamicQueryUtil;
...
public class GaeaQueryAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.anjiplus.template.common.aop.GaeaQuery)")

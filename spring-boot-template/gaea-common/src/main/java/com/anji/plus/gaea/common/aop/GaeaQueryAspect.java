package com.anji.plus.gaea.common.aop;
...
import com.anji.plus.gaea.common.util.DynamicQueryUtil;
...
public class GaeaQueryAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.anji.plus.gaea.common.aop.GaeaQuery)")

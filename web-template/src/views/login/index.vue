      ...
      <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login_form" autocomplete="on" label-position="left" @keyup.enter.native="handleLogin">
        <div class="title_container">
          <h3 class="title">
            HELLO,
            <br>
            <p class="title_name">{{ $t('login.title') }}</p>
          </h3>
        ...
        <div class="form_fields">
          ...
          <div>
            ...
            <el-form-item prop="username">
              <el-input ref="username" v-model="loginForm.username" :placeholder="$t('login.username')" name="username" type="text" tabindex="1" autocomplete="on" @focus="setTop('0')" @change="getPsw" />
            </el-form-item>
          </div>
          <div>
...
export default {
  ...
  data() {
    return {
      ...
      loginRules: {
        username: [{ required: true, message: this.$t('login.nameMsg'), trigger: 'blur' }],
        password: [{ required: true, message: this.$t('login.pswMsg'), trigger: 'blur' }],
      }, // 登录表单验证

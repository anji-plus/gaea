 ...
 */
public class GaeaMessageSourceAccessor {
	 ...
	 */
	public GaeaMessageSourceAccessor(MessageSource messageSource) {
	 ...
	 */
	public GaeaMessageSourceAccessor(MessageSource messageSource, Locale defaultLocale) {
		this.messageSource = messageSource;
	 ...
	 * @see #GaeaMessageSourceAccessor(MessageSource, Locale)
	 * @see LocaleContextHolder#getLocale()
	 */
